    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateDriverAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                TitleDriver.setText("Mechanic Registration");
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            if(task.isSuccessful())
                            {
                                ...
                                driversDatabaseRef = FirebaseDatabase.getInstance().getReference().child("User").child("Mechanics").child(currentUserId);
                            ...
                            {
                                Toast.makeText(DriverLoginRegisterActivity.this, task.getException().getLocalizedMessage(), Toast.LENGTH_SHORT).show();
